...
import type { Collection, Document, Filter, Document as Projection, Sort } from 'mongodb'
...
export async function sendPaginatedResponse<T extends Document>(
  res: Response,
  next: NextFunction,
...
export function sendPaginatedResponseFromRedis<T>(
  res: Response,
  next: NextFunction,
  data: T[],
