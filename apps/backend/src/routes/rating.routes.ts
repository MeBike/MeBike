...
import { addNewRatingController, getRatingByIdController, getRatingController, getRatingReasonsController } from '~/controllers/ratings.controllers'
...
ratingRouter.get('/:rental_id', accessTokenValidator, isAdminValidator, wrapAsync(getRatingByIdController))
