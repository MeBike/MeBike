...
export const stationSchema = z.object({
  ...
  latitude: z.number(),
  longitude: z.number(),
  totalCapacity: z.number().min(1,"Sức chứa không được để trống").max(40,"Không được quá 40 chiếc"),
  stationType: z.enum(["INTERNAL","AGENCY"]),
  returnSlotLimit : z.number().min(1,"Số lượng trả xe tối đa không được để trống"),
});
