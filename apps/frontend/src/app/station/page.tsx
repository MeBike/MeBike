              ...
              <CardContent className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <p className="text-gray-600">
                      Capacity: {formatNumber(selectedStation.capacity)}
                    </p>
                    <p className="text-gray-600">
                      Chỗ trống: {formatNumber(selectedStation.emptySlots)}
                    </p>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    <div className="bg-green-50 p-3 rounded-lg">
                      ...
                      <div className="text-xl font-bold text-green-800">
                        {formatNumber(selectedStation.availableBikes)}
                      </div>
                    </div>
                    <div className="bg-blue-50 p-3 rounded-lg">
                      <div className="text-xs text-blue-700">Tổng xe</div>
                      <div className="text-xl font-bold text-blue-800">
                        {formatNumber(selectedStation.totalBikes)}
                      </div>
                    </div>
                    <div className="bg-yellow-50 p-3 rounded-lg">
                      <div className="text-xs text-yellow-700">Đã đặt</div>
                      <div className="text-xl font-bold text-yellow-800">
                        {formatNumber(selectedStation.bookedBikes)}
                      </div>
                    </div>
                    <div className="bg-red-50 p-3 rounded-lg">
                      <div className="text-xs text-red-700">Hỏng</div>
                      <div className="text-xl font-bold text-red-800">
                        {formatNumber(selectedStation.brokenBikes)}
                      </div>
                    </div>
                    <div className="bg-purple-50 p-3 rounded-lg">
                      <div className="text-xs text-purple-700">Dự trữ</div>
                      <div className="text-xl font-bold text-purple-800">
                        {formatNumber(selectedStation.reservedBikes)}
                      </div>
                    </div>
                    <div className="bg-orange-50 p-3 rounded-lg">
                      <div className="text-xs text-orange-700">Bảo trì</div>
                      <div className="text-xl font-bold text-orange-800">
                        {formatNumber(selectedStation.maintainedBikes)}
                      </div>
                    </div>
                    <div className="bg-gray-50 p-3 rounded-lg">
                      <div className="text-xs text-gray-700">Không khả dụng</div>
                      <div className="text-xl font-bold text-gray-800">
                        {formatNumber(selectedStation.unavailableBikes)}
                      </div>
                    </div>
                  </div>
                </div>
