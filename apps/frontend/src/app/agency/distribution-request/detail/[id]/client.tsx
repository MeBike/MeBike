      ...
      <div className="flex flex-col gap-5 md:flex-row md:items-start md:justify-between border-b pb-6">
        <div className="space-y-3">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
            ...
            <span
              className={`px-2.5 py-0.5 rounded-full text-[11px] font-bold border uppercase w-fit ${statusInfo.style}`}
            >
              {statusInfo.label}
            </span>
          </div>
          ...
          <Card className="shadow-sm border-slate-200 overflow-hidden">
            <CardHeader className="bg-slate-50/80 pb-4 border-b">
              <CardTitle className="text-base flex items-center gap-2 text-slate-800">
                <ClipboardList className="h-5 w-5 text-blue-500" /> Thông tin cơ
                bản
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-5 pt-5 text-sm">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-blue-50/50 p-3 rounded-lg border border-blue-100">
                  <span className="text-slate-500 block text-xs font-medium uppercase tracking-wider mb-1">
                    Số lượng
                  </span>
              ...
              <div className="pt-2">
                <span className="text-slate-500 block font-medium mb-2">
                  Người yêu cầu
                </span>
      ...
      <Dialog open={showRejectModal} onOpenChange={setShowRejectModal}>
        <DialogContent className="sm:max-w-md">
          ...
          <div className="py-4 space-y-3">
            ...
            />
            <p
              className={`text-xs text-right font-medium ${isValid ? "text-emerald-600" : "text-rose-500"}`}
            >
