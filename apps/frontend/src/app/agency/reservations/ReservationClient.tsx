...
interface ReservationClientProps {
  data: {
    allReservationsAgency?: ApiResponse<Reservation[]>; // Dữ liệu của Agency
    stations: Station[];
...
export default function ReservationClient({
  data: { allReservationsAgency, stations, isVisualLoading },
  ...
  const handleDetailReservation = (id: string) => {
    router.push(`/agency/reservations/detail/${id}`); // Path cho Agency
  };
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-foreground">
            Quản lý đặt trước (Agency)
          </h1>
          <p className="mt-1 text-muted-foreground">
            Theo dõi và quản lý các đơn đặt trước tại Agency của bạn
          </p>
        </div>
      </div>
      ...
      <div className="rounded-xl border border-border bg-card shadow-sm transition-all">
        ...
        <div className="flex flex-wrap items-center gap-6 p-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            >
              <SelectTrigger className="h-9 w-[180px] border-border/60 bg-background/50 text-sm">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            >
              <SelectTrigger className="h-9 w-[200px] border-border/60 bg-background/50 text-sm">
          ...
          <>
            <div className="mb-4 flex items-center justify-between">
              <p className="text-sm text-muted-foreground">
                ...
                {allReservationsAgency?.pagination?.totalPages ?? 1}
              </p>
            </div>
            <DataTable
