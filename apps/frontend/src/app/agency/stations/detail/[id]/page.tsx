...
export default function StationDetailPage() {
  ...
  const { myStationDetail, isLoadingMyStationDetail, getMyStationDetail, responseStationRevenueForAgency, isLoadingStationRevenueForAgency, getStationRevenueForAgency } =
    useAgencyActions({
      hasToken: true,
      station_id: id,
    });
  ...
  const rawRevenueData = (responseStationRevenueForAgency as any)?.data || responseStationRevenueForAgency;
