...
const StationMapDynamic = dynamic(
  () =>
    import("@/app/admin/stations/components/station-map").then(
      (mod) => mod.StationMap,
    ),
  {
    ssr: false,
...
export default function CreateAgencyClient({
  onCreateAgency,
}: CreateAgencyClientProps) {
      ...
      <Form {...form}>
        ...
        >
          <div className="lg:col-span-5 space-y-6">
              ...
              <CardContent className="pt-4 space-y-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-[10px] uppercase font-bold">
                        Tên Agency <span className="text-red-500">*</span>
                      </FormLabel>
                      <FormControl>
                        <Input placeholder="Tên công ty/Cửa hàng" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="col-span-2">
                        <FormLabel className="text-[10px] uppercase font-bold">
                          Địa chỉ Agency <span className="text-red-500">*</span>
                        </FormLabel>
                        <FormControl>
            ...
            <Card className="shadow-sm border-primary/10">
              ...
              <CardContent className="pt-4 space-y-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="VD: Trạm MeBike A" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <div className="grid grid-cols-2 gap-4">
                  <FormField
                    control={form.control}
                    name="stationTotalCapacity"
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-[10px] uppercase font-bold">
                          Tổng sức chứa <span className="text-red-500">*</span>
                        </FormLabel>
                        <FormControl>
                          <Input
                            type="number"
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-[10px] uppercase font-bold">
                        Địa chỉ trạm <span className="text-red-500">*</span>
                      </FormLabel>
                      <FormControl>
                        <Input placeholder="Địa chỉ thực tế..." {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
            ...
            >
              {isSubmitting ? (
                ...
                <>
                  <Send className="mr-2 h-5 w-5" /> Tạo Agency
                </>
              )}
            </Button>
          </div>
          ...
          <div className="lg:col-span-7">
            {/* Chỉnh min-h lên 700px hoặc h-full để card giãn theo chiều cao trang */}
            <Card className="h-[700px] flex flex-col overflow-hidden border-primary/10 shadow-md">
              <CardHeader className="py-3 bg-muted/20 border-b flex flex-row items-center justify-between">
                ...
                <div className="flex gap-2">
                  <Badge variant="secondary" className="font-mono text-[10px]">
                    Lat: {form.watch("stationLatitude")?.toFixed(5)}
                  </Badge>
                  <Badge variant="secondary" className="font-mono text-[10px]">
                    Lng: {form.watch("stationLongitude")?.toFixed(5)}
                  </Badge>
                </div>
              </CardHeader>
              {/* Quan trọng: CardContent cần flex-1 và h-full */}
