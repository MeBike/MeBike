        ...
        <div className="space-y-6 lg:col-span-2">
          <SectionCard icon={BikeIcon} title="Thông tin cơ bản">
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              ...
              />
              <Field label="Loại xe" value={bike.type || "Xe đạp điện"} />
              <Field label="Nhà cung cấp" value={bike.supplierId || "Hệ thống"} />
            </div>
          </SectionCard>
          ...
          <SectionCard icon={Activity} title="Thống kê hoạt động">
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center border-b pb-2">
                ...
                <span className="font-bold text-foreground">{totalHours}h {activity ? activity.totalMinutesActive % 60 : 0}m</span>
              </div>
              <div className="flex justify-between items-center border-b pb-2">
