...
interface WithdrawStatsProps {
  stats: WithdrawOverview;
}

export function WithdrawStats({ stats }: WithdrawStatsProps) {
  return (
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-accent mt-1">
                {Number(
                  stats.totalCompletedWithdrawAmount.$numberDecimal
