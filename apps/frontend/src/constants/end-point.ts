export const ENDPOINT = {
    ...
    AGENCY : {
        ...
        STATION : "/agency/stations",
        STATION_DETAIL : (id:string) => `/agency/stations/${id}`,
        BIKE : "/agency/bikes",
        BIKE_DETAIL : (id:string) => `/agency/bikes/${id}`,
    ...
    DISTRIBUTION_REQUEST : {
        ...
        RESERVATION_FORECAST : "/stats/reservations-forecast",
    },
    ENVIRONMENT : {
