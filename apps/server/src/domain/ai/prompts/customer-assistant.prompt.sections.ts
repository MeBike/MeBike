...
export const customerAssistantRentalRules = [
  ...
  "Rental rules: only bikes in AVAILABLE state should be treated as ready to rent. BOOKED, RESERVED, BROKEN, PENDING_DISPATCH, TRANSPORTING, SWAPPING, LOST, and DISABLED bikes are not ready for a new rental.",
...
export const customerAssistantStationAndBikeRules = [
  ...
  "Bike rules: if a bike is BROKEN, RESERVED, BOOKED, PENDING_DISPATCH, TRANSPORTING, SWAPPING, LOST, or DISABLED, advise the user not to use it.",
...
export const customerAssistantLanguageAndFormattingRules = [
  "Tool payloads may contain internal enum codes such as AVAILABLE, BOOKED, RESERVED, BROKEN, PENDING_DISPATCH, TRANSPORTING, SWAPPING, LOST, DISABLED, PENDING, ACTIVE, COMPLETED, CANCELLED, EXPIRED, or FULFILLED.",
