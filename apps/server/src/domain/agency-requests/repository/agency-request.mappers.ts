...
export const selectAgencyRequestRow = {
  ...
  stationTotalCapacity: true,
  stationPickupSlotLimit: true,
  stationReturnSlotLimit: true,
  status: true,
  description: true,
...
export function toAgencyRequestRow(
  ...
  return {
    ...
    stationLatitude: row.stationLatitude ? Number(row.stationLatitude) : null,
    stationLongitude: row.stationLongitude ? Number(row.stationLongitude) : null,
