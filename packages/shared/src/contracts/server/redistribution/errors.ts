...
export const redistributionReqErrorMessages: Record<RedistributionReqErrorCode, string> = {
  ...
  UNAUTHORIZED_REDISTRIBUTION_REVERT: "You are not authorized to revert this redistribution request",
  // 400
  ...
  CANNOT_REVERT_NON_TRANSIT_OR_PARTIALLY_COMPLETED_REDISTRIBUTION: "Cannot revert redistribution request that is not in transit or partially completed state",
