...
export const ReservationErrorCodeSchema = z
  .enum([
    ...
    "BIKE_IS_PENDING_DISPATCH",
    "BIKE_IS_TRANSPORTING",
    "BIKE_IS_SWAPPING",
    "BIKE_IS_LOST",
    "BIKE_IS_DISABLED",
    "BIKE_NOT_AVAILABLE",
...
export const reservationErrorMessages = {
  ...
  BIKE_IS_PENDING_DISPATCH: "Bike is being dispatched",
  BIKE_IS_TRANSPORTING: "Bike is being transported",
  BIKE_IS_SWAPPING: "Bike is being swapped",
