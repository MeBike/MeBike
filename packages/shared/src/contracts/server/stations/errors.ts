...
export const stationErrorCodes = [
  ...
  "PICKUP_SLOT_LIMIT_BELOW_PENDING_RESERVATIONS",
...
export const StationErrorDetailSchema = ServerErrorDetailSchema.extend({
  ...
  pickupSlotLimit: z.number().int().nonnegative().optional(),
...
export const stationErrorMessages: Record<StationErrorCode, string> = {
  ...
  PICKUP_SLOT_LIMIT_BELOW_PENDING_RESERVATIONS: "Pickup slot limit cannot be lower than pending reservations",
