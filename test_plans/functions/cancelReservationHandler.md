# Test Cases cho Hàm: `cancelReservationHandler`

**Nằm trong file**: me.controller.ts
**Function Code**: FUNC_CANCELRESERVATIONHANDLER
**Function Name**: `cancelReservationHandler`
...
#### TC_002: Xử lý ngoại lệ `ReservationNotFound` (Abnormal Flow)
**a. Condition:**
...
#### TC_003: Xử lý ngoại lệ `ReservationNotOwned` (Abnormal Flow)
**a. Condition:**
...
#### TC_004: Xử lý ngoại lệ `InvalidReservationTransition` (Abnormal Flow)
**a. Condition:**
...
#### TC_005: Xử lý ngoại lệ `BikeNotFound` (Abnormal Flow)
**a. Condition:**
