# Test Cases cho Hàm: `getRequestDetailForStaff`

**Nằm trong file**: staff.controller.ts
**Function Code**: FUNC_GETREQUESTDETAILFORSTAFF
**Function Name**: `getRequestDetailForStaff`
...
#### TC_002: Xử lý ngoại lệ `RedistributionRequestNotFound` (Abnormal Flow)
**a. Condition:**
...
#### TC_003: Xử lý ngoại lệ `UnauthorizedRedistributionAccess` (Abnormal Flow)
**a. Condition:**
