# Test Cases cho Hàm: `getMyCurrentReturnSlot`

**Nằm trong file**: me.controller.ts
**Function Code**: FUNC_GETMYCURRENTRETURNSLOT
**Function Name**: `getMyCurrentReturnSlot`
...
#### TC_003: Xử lý ngoại lệ `ReturnSlotRequiresActiveRental` (Abnormal Flow)
**a. Condition:**
