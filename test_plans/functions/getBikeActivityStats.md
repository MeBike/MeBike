# Test Cases cho Hàm: `getBikeActivityStats`

**Nằm trong file**: stats.controller.ts
**Function Code**: FUNC_GETBIKEACTIVITYSTATS
**Function Name**: `getBikeActivityStats`
...
#### TC_002: Xử lý ngoại lệ `BikeNotFound` (Abnormal Flow)
**a. Condition:**
