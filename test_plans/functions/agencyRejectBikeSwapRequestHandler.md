# Test Cases cho Hàm: `agencyRejectBikeSwapRequestHandler`

**Nằm trong file**: agency.controller.ts
**Function Code**: FUNC_AGENCYREJECTBIKESWAPREQUESTHANDLER
**Function Name**: `agencyRejectBikeSwapRequestHandler`
