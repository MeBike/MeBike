# Test Cases cho Hàm: `createStation`

**Nằm trong file**: admin.controller.ts
**Function Code**: FUNC_CREATESTATION
**Function Name**: `createStation`
...
#### TC_002: Xử lý ngoại lệ `StationNameAlreadyExists` (Abnormal Flow)
**a. Condition:**
...
#### TC_003: Xử lý ngoại lệ `StationCapacityLimitExceeded` (Abnormal Flow)
**a. Condition:**
...
#### TC_004: Xử lý ngoại lệ `StationCapacitySplitInvalid` (Abnormal Flow)
**a. Condition:**
...
#### TC_005: Xử lý ngoại lệ `StationOutsideSupportedArea` (Abnormal Flow)
**a. Condition:**
...
#### TC_006: Xử lý ngoại lệ `StationAgencyRequired` (Abnormal Flow)
**a. Condition:**
...
#### TC_007: Xử lý ngoại lệ `StationAgencyForbidden` (Abnormal Flow)
**a. Condition:**
...
#### TC_008: Xử lý ngoại lệ `StationAgencyNotFound` (Abnormal Flow)
**a. Condition:**
...
#### TC_009: Xử lý ngoại lệ `StationAgencyAlreadyAssigned` (Abnormal Flow)
**a. Condition:**
