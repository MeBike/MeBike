# Test Cases cho Hàm: `login`

**Nằm trong file**: auth.controller.ts
**Function Code**: FUNC_LOGIN
**Function Name**: `login`
...
#### TC_002: Xử lý ngoại lệ `InvalidCredentials` (Abnormal Flow)
**a. Condition:**
- **Precondition**: Gặp trường hợp ngoại lệ liên quan đến `InvalidCredentials` trong quá trình xử lý.
- **Values of inputs (Abnormal)**: Thông số đầu vào không hợp lệ với yêu cầu của trạng thái hiện tại (hoặc đối tượng không tồn tại).
**b. Confirmation:**
- **Output result**: Lỗi 400/403/404, hiển thị mã error: `InvalidCredentials`.
**c. Type & Result:**
- **Type**: Abnormal
- **Result**: [ ] P / F
