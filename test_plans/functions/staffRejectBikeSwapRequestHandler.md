# Test Cases cho Hàm: `staffRejectBikeSwapRequestHandler`

**Nằm trong file**: staff.controller.ts
**Function Code**: FUNC_STAFFREJECTBIKESWAPREQUESTHANDLER
**Function Name**: `staffRejectBikeSwapRequestHandler`
...
#### TC_005: Xử lý ngoại lệ `RentalRepositoryError` (Abnormal Flow)
**a. Condition:**
