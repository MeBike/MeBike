# Test Cases cho Hàm: `adminListUserWalletTransactions`

**Nằm trong file**: admin.controller.ts
**Function Code**: FUNC_ADMINLISTUSERWALLETTRANSACTIONS
**Function Name**: `adminListUserWalletTransactions`
...
#### TC_002: Xử lý ngoại lệ `WalletNotFound` (Abnormal Flow)
**a. Condition:**
