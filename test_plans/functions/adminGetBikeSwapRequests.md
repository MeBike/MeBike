# Test Cases cho Hàm: `adminGetBikeSwapRequests`

**Nằm trong file**: admin.controller.ts
**Function Code**: FUNC_ADMINGETBIKESWAPREQUESTS
**Function Name**: `adminGetBikeSwapRequests`
...
#### TC_002: Xử lý ngoại lệ `AdminBikeRequestNotFound` (Abnormal Flow)
**a. Condition:**
- **Precondition**: Gặp trường hợp ngoại lệ liên quan đến `AdminBikeRequestNotFound` trong quá trình xử lý.
- **Values of inputs (Abnormal)**: Thông số đầu vào không hợp lệ với yêu cầu của trạng thái hiện tại (hoặc đối tượng không tồn tại).
**b. Confirmation:**
- **Output result**: Lỗi 400/403/404, hiển thị mã error: `AdminBikeRequestNotFound`.
**c. Type & Result:**
- **Type**: Abnormal
- **Result**: [ ] P / F
