# Test Cases cho Hàm: `getActivePolicy`

**Nằm trong file**: policies.controller.ts
**Function Code**: FUNC_GETACTIVEPOLICY
**Function Name**: `getActivePolicy`
...
#### TC_002: Xử lý ngoại lệ `ActiveEnvironmentPolicyNotFound` (Abnormal Flow)
**a. Condition:**
