# Test Cases cho Hàm: `debitMyWallet`

**Nằm trong file**: me.controller.ts
**Function Code**: FUNC_DEBITMYWALLET
**Function Name**: `debitMyWallet`
...
#### TC_002: Xử lý ngoại lệ `InsufficientWalletBalance` (Abnormal Flow)
**a. Condition:**
