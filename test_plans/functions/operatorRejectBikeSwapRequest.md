# Test Cases cho Hàm: `operatorRejectBikeSwapRequest`

**Nằm trong file**: operator.controller.ts
**Function Code**: FUNC_OPERATORREJECTBIKESWAPREQUEST
**Function Name**: `operatorRejectBikeSwapRequest`
...
#### TC_002: Xử lý ngoại lệ `OperatorBikeSwapRequestNotFound` (Abnormal Flow)
**a. Condition:**
- **Precondition**: Gặp trường hợp ngoại lệ liên quan đến `OperatorBikeSwapRequestNotFound` trong quá trình xử lý.
- **Values of inputs (Abnormal)**: Thông số đầu vào không hợp lệ với yêu cầu của trạng thái hiện tại (hoặc đối tượng không tồn tại).
**b. Confirmation:**
- **Output result**: Lỗi 400/403/404, hiển thị mã error: `OperatorBikeSwapRequestNotFound`.
**c. Type & Result:**
- **Type**: Abnormal
- **Result**: [ ] P / F

#### TC_003: Xử lý ngoại lệ `BikeSwapRequestNotFound` (Abnormal Flow)
**a. Condition:**
...
#### TC_004: Xử lý ngoại lệ `InvalidBikeSwapRequestStatus` (Abnormal Flow)
**a. Condition:**
