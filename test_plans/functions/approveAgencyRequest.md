# Test Cases cho Hàm: `approveAgencyRequest`

**Nằm trong file**: admin.controller.ts
**Function Code**: FUNC_APPROVEAGENCYREQUEST
**Function Name**: `approveAgencyRequest`
...
#### TC_003: Xử lý ngoại lệ `InvalidAgencyRequestStatusTransition` (Abnormal Flow)
**a. Condition:**
