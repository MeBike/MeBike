# Test Cases cho Hàm: `getAgencyOperationalStats`

**Nằm trong file**: stats.controller.ts
**Function Code**: FUNC_GETAGENCYOPERATIONALSTATS
**Function Name**: `getAgencyOperationalStats`
...
#### TC_002: Xử lý ngoại lệ `AgencyNotFound` (Abnormal Flow)
**a. Condition:**
- **Precondition**: Gặp trường hợp ngoại lệ liên quan đến `AgencyNotFound` trong quá trình xử lý.
- **Values of inputs (Abnormal)**: Thông số đầu vào không hợp lệ với yêu cầu của trạng thái hiện tại (hoặc đối tượng không tồn tại).
**b. Confirmation:**
- **Output result**: Lỗi 400/403/404, hiển thị mã error: `AgencyNotFound`.
**c. Type & Result:**
- **Type**: Abnormal
- **Result**: [ ] P / F
