# Test Cases cho Hàm: `updateBike`

**Nằm trong file**: admin.controller.ts
**Function Code**: FUNC_UPDATEBIKE
**Function Name**: `updateBike`
...
#### TC_005: Xử lý ngoại lệ `DuplicateChipId` (Abnormal Flow)
**a. Condition:**
...
#### TC_006: Xử lý ngoại lệ `BikeStationNotFound` (Abnormal Flow)
**a. Condition:**
...
#### TC_007: Xử lý ngoại lệ `BikeSupplierNotFound` (Abnormal Flow)
**a. Condition:**
