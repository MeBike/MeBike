# Test Cases cho Hàm: `cancelMyReturnSlot`

**Nằm trong file**: me.controller.ts
**Function Code**: FUNC_CANCELMYRETURNSLOT
**Function Name**: `cancelMyReturnSlot`
...
#### TC_003: Xử lý ngoại lệ `ReturnSlotNotFound` (Abnormal Flow)
**a. Condition:**
- **Precondition**: Gặp trường hợp ngoại lệ liên quan đến `ReturnSlotNotFound` trong quá trình xử lý.
- **Values of inputs (Abnormal)**: Thông số đầu vào không hợp lệ với yêu cầu của trạng thái hiện tại (hoặc đối tượng không tồn tại).
**b. Confirmation:**
- **Output result**: Lỗi 400/403/404, hiển thị mã error: `ReturnSlotNotFound`.
**c. Type & Result:**
- **Type**: Abnormal
- **Result**: [ ] P / F
