# Test Cases cho Hàm: `getSupplierStats`

**Nằm trong file**: stats.controller.ts
**Function Code**: FUNC_GETSUPPLIERSTATS
**Function Name**: `getSupplierStats`
...
#### TC_002: Xử lý ngoại lệ `SupplierNotFound` (Abnormal Flow)
**a. Condition:**
